package com.mayak.chuckchuck.security.oauth2.handler;
...
import com.mayak.chuckchuck.security.oauth2.user.OAuth2Provider;
import com.mayak.chuckchuck.security.oauth2.user.OAuth2UserInfo;
import com.mayak.chuckchuck.security.oauth2.user.OAuth2UserInfoFactory;
...
import static com.mayak.chuckchuck.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        SocialCode socialCode = SocialCode.valueOf(authToken.getAuthorizedClientRegistrationId().toUpperCase());
        ...
        AuthToken accessToken = authTokenProvider.createAuthToken(userInfo.getEmail(), roleType.getCode(), socialCode, appProperties.getAuth().getTokenExpiry());
        ...
        User user = userRepository.findBySocialCodeAndEmail(userInfo.getSocialCode(), userInfo.getEmail())
