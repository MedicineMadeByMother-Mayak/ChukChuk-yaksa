package com.mayak.chuckchuck.security.oauth2.service;

import com.mayak.chuckchuck.domain.User;
import com.mayak.chuckchuck.security.oauth2.exception.OAuth2AuthenticationProcessingException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest userRequest, OAuth2User oAuth2User) {
        ...
        // 이미 가입한 유저인지 체크
        User savedUser = userRepository.findBySocialCodeAndEmail(userInfo.getSocialCode(), userInfo.getEmail()).orElse(null);
