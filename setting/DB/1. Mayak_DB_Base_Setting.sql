...
CREATE TABLE `pill` (
  ...
  `warning_pregnant` 		boolean					DEFAULT false,
  `warning_use_date` 		boolean					DEFAULT false,
  `warning_elders` 			boolean					DEFAULT false,
  `warning_together` 		boolean 				DEFAULT false,
  `create_date` 			datetime      			DEFAULT NOW(),
  `modify_date` 			datetime      			DEFAULT NULL,
  `is_delete` 				boolean 				DEFAULT false,
