<template>
  <div class="modal-overlay" @click="$emit('close')">
    <div class="modal">
      <ul class="modal-menu">
        <li @click="editListName">
          <strong style="color: black">제목 수정</strong>하기
        </li>
        <hr style="margin: 0px 10px" />
        <li @click="deleteList">
          <strong style="color: black">리스트 삭제</strong>하기
        </li>
        <hr style="margin: 0px 10px" />
        <li @click="finishCurrentList">
          <strong style="color: black">복용 완료</strong> 처리하기
        </li>
      </ul>
    </div>
  </div>
